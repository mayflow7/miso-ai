...
**단계**: MVP 1 완성 + 03_instruction 반영 완료
...
├── data\
│   └── responses.ts            — 버튼별 응답 메시지 풀 (총 521개)
├── hooks\
...
| 버튼 | Emotion | 응답 수 |
|---|---|---|
| 👋 Hi there | happy | 175개 랜덤 |
| 💕 Loving you | love | 169개 랜덤 |
| ✨ Happy day | excited | 177개 랜덤 |

- **총 521개** 메시지 풀 (`data/responses.ts`)
- 메시지 주제: 인사/그리움/에너지(hi), 애정/설렘/감사(loving), 기쁨/에너지/신남(happy)
